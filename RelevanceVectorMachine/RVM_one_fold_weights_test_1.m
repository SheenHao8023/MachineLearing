function [perf,ypred_val,y_val,weights] = RVM_one_fold_weights_test_1(x, y, cv_ind, fold, confounds, CovCateIdx)
% 
...
confounds_train = [confounds_train(:,1) zscore(confounds_train(:,2:3))];
confounds_val = [confounds_val(:,1) (confounds_val(:,2)-confounds_mean(1))/confounds_std(1) (confounds_val(:,3)-confounds_mean(2))/confounds_std(2)];
